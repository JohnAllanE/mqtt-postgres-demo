#!/usr/bin/env python3
"""Gateway server: accepts simulator TCP input and forwards to WebSocket clients.

This component runs on the server-side and demonstrates transport between the
simulator and web clients. It listens for TCP connections from simulators and
broadcasts received JSON batches to any connected WebSocket clients.
"""
import asyncio
import json
